...
class OntologyEditor:
    ...
    async def apply_suggestion(self, suggestion: Dict[str, Any]) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            if suggestion_type == "add_entity":
                return await self._add_entity_suggestion(target, changes, rationale)
            elif suggestion_type == "modify_entity":
                return await self._modify_entity_suggestion(target, changes, rationale)
            elif suggestion_type == "add_relationship":
                return await self._add_relationship_suggestion(target, changes, rationale)
            elif suggestion_type == "modify_relationship":
                return await self._modify_relationship_suggestion(target, changes, rationale)
            else:
    ...
    async def _add_entity_suggestion(self, entity_name: str, details: str, rationale: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            return True, f"Added entity '{entity_name}'"

        except Exception as e:
            return False, f"Error creating entity: {str(e)}"

    async def _modify_entity_suggestion(self, entity_name: str, changes: str, rationale: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            return True, f"Modified entity '{entity_name}'"

        except Exception as e:
            return False, f"Error modifying entity: {str(e)}"

    async def _add_relationship_suggestion(self, relationship_desc: str, details: str, rationale: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            if not (source_exists and target_exists):
                return False, f"Source or target entity does not exist: {source_name} -> {target_name}"
            ...
            return True, f"Added relationship: {source_name} -> {relationship_data.get('label')} -> {target_name}"

        except Exception as e:
            return False, f"Error creating relationship: {str(e)}"

    async def _modify_relationship_suggestion(self, relationship_id: str, changes: str, rationale: str) -> Tuple[bool, str]:
        """Modify an existing relationship."""
        # Simplified implementation - would need better relationship identification
        return False, "Relationship modification not yet implemented"
